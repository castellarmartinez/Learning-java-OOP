...
public class StatisticsGreatPyramidGiza {
   public static void main(String[] args) {
      ...
      System.out.printf("The estimate weight of the pyramid that was built" +
              " every year was: %.0f", STONES_BY_YEAR * AVG_WEIGHT_STONE);
      System.out.printf("The estimate weight of the pyramid that was built" +
              " every hour was: %.0f", STONES_BY_YEAR * AVG_WEIGHT_STONE / 8760);
      System.out.printf("The estimate weight of the pyramid that was built" +
              " every minute was: %.0f", STONES_BY_YEAR * AVG_WEIGHT_STONE / 525600);
   }
}
